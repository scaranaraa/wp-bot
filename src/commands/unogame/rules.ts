import { type Ruleset } from '../../types/unotypes.js';
...
export const rules: Ruleset = {
	...
	DM_USERHAND: {
		desc: "Dm the user's hand at each turn",
		value: true,
		name: 'Dm userhand',
		type: 'boolean',
	},
	...
	IMAGE: {
		desc: 'Send cards as images rather than text.',
		value: true,
		name: 'Transcript',
		type: 'boolean',
	},
...
export const ruleKeys = Object.keys(rules);
