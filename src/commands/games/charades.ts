				...
				for (const word of words) {
					if (
						...
						await game.client.sendMessage(
							game.chatid,
							'You cannot use the word or similar words while describing!'
						);
						canguess = false;
						game.lives--;
						game.client.removeListener('message_create', wait);
