...
for line in sys.stdin:
    ...
    result = client.predict(
            ...
            r"./src/commands/utils/female.wav",	# str (filepath on your computer (or URL) of file) in 'Reference Audio' Audio component
            r"./src/commands/utils/female.wav",	# str (filepath on your computer (or URL) of file) in 'Use Microphone for Reference' Audio component
